...
def main():
    ...
    parser.add_argument("-q", "--quality", choices=QUALITY_PRESETS.keys(), 
                       default="preview", help="Render quality")
    parser.add_argument("-p", "--parallel", action="store_true", 
                       help="Render in parallel")
    ...
    if not args.scenes:
        ...
        if "all" in args.scenes:
            ...
            for name in args.scenes:
                ...
                scene = None
                for s in SCENES:
                    if (s["name"].lower() == name.lower() or 
                        s["class"].lower() == name.lower()):
                        scene = s
                        break
